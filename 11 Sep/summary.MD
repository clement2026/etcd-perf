...
The analysis above focuses solely on the heap size of etcd. It doesn’t include memory allocated through `mmap`(used by bbolt) and `cgo`. To find out how much physical
